...
public abstract class TunnelRequest {
	...
	public static final String ENABLE_SFTP_PARAMETER = "enable-sftp";
	
	public static final String ENABLE_DRIVE_PARAMETER = "enable-drive";

	public static final String DRIVE_PATH_PARAMETER = "drive-path";
	...
	public String getEnableSftp() throws GuacamoleException {
        return getParameter(ENABLE_SFTP_PARAMETER);
    }
	
	public String getEnableDrive() throws GuacamoleException {
        return getParameter(ENABLE_DRIVE_PARAMETER);
    }
	
	public String getDrivePath() throws GuacamoleException {
        return getParameter(DRIVE_PATH_PARAMETER);
    }
	
	public String getProtocol() throws GuacamoleException {
        return getParameter(PROTOCOL_PARAMETER);
    }
    ...
    public String getHostname() throws GuacamoleException {
        return getParameter(HOSTNAME_PARAMETER);
    }
