...
public class TunnelRequestService {
    ...
    private GuacamoleConfiguration buildConfig(final TunnelRequest request) throws GuacamoleException {
        ...
        config.setProtocol(request.getProtocol().toString());
        ...
        if (request.getEnableDrive() != null) {
            config.setParameter("enable-drive", request.getEnableDrive());
        }

        if (request.getDrivePath() != null) {
            config.setParameter("drive-path", request.getDrivePath());
        }

        if (request.getEnableSftp() != null) {
            config.setParameter("enable-sftp", request.getEnableSftp());
        }
